...
│   ├── index.html      # Articles landing page (51 articles grid)
...
│       └── # 51 article pages, the-paradigm-shift.html … the-hard-choice-quadrant.html
...
| Technical Articles | `/articles/` | 51-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`) |
...
| Ruku Hifz | `/apps/ruku-hifz/` | Quran memorization workspace that shows one ruku a page with the verse before it and the verse after it for continuity — seamless paging across surah boundaries, jump by surah or ruku number, blur-to-recall self-testing, and per-ruku progress across all 551 rukus |
