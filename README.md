...
│   ├── index.html      # Articles landing page (31 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01.png through Image_31.png)
...
│       └── # 31 article pages, the-paradigm-shift.html … the-taste-gap.html
└── apps/
...
| Technical Articles | `/articles/` | 31-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme) |
