...
│   ├── Post_Images/    # Hero images for articles (Image_NN.png/.jpg, or .svg for authored vector heroes; Fig_NN_* for in-article raster figures)
...
| Technical Articles | `/articles/` | 54-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`); heroes may also be authored SVG (see `Post_Images/Image_54.svg`) |
