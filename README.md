...
│   ├── index.html      # Articles landing page (52 articles grid)
...
│       └── # 52 article pages, the-paradigm-shift.html … three-tenses-one-budget.html
...
| Technical Articles | `/articles/` | 52-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`) |
