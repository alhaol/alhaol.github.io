...
| Habit Tracker | `/apps/habit-tracker/` | Daily tracker for the same nine micro-habits in their three pillars: one tap marks a habit done, each card keeps a streak and shows the last seven days as bars, hovering a card enlarges it, and every habit carries its own hand-drawn icon |
