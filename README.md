...
│   ├── index.html      # Articles landing page (36 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_36, .png/.jpg)
...
| Technical Articles | `/articles/` | 36-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme) |
