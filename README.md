...
│   ├── index.html      # Articles landing page (49 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_49, .png/.jpg; Fig_NN_* for in-article raster figures)
...
│       └── # 49 article pages, the-paradigm-shift.html … sovereignty-at-the-tokenizer.html
...
| Technical Articles | `/articles/` | 49-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`) |
