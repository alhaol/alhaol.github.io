...
│   ├── index.html      # Articles landing page (45 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_45, .png/.jpg; Fig_NN_* for in-article raster figures)
...
│       └── # 45 article pages, the-paradigm-shift.html … the-happiness-loop.html
...
| Technical Articles | `/articles/` | 45-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`) |
