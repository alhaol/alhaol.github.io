...
│   ├── index.html      # Articles landing page (35 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_35, .png/.jpg)
...
│       └── # 35 article pages, the-paradigm-shift.html … the-harness-advantage.html
└── apps/
...
| Technical Articles | `/articles/` | 35-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme) |
