...
│   ├── index.html      # Articles landing page (46 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_46, .png/.jpg; Fig_NN_* for in-article raster figures)
...
│       └── # 46 article pages, the-paradigm-shift.html … router-to-conductor.html
...
| Technical Articles | `/articles/` | 46-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`) |
