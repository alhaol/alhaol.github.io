...
│   ├── index.html      # Articles landing page (63 articles grid)
...
│       └── # 63 article pages, the-paradigm-shift.html … the-rediscovery-tax.html (plus verbs-not-nouns.ar.html, the first Arabic RTL edition)
...
| Technical Articles | `/articles/` | 63-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`); heroes are authored as vector art and exported to `Post_Images/Image_NN.png` |
