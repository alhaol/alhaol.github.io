...
│   ├── index.html      # Articles landing page (37 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_37, .png/.jpg)
...
│       └── # 37 article pages, the-paradigm-shift.html … intelligence-is-applied-causality.html
└── apps/
...
| Technical Articles | `/articles/` | 37-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme) |
