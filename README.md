...
│   ├── index.html      # Articles landing page (34 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01 through Image_34, .png/.jpg)
...
│       └── # 34 article pages, the-paradigm-shift.html … simplicity-scales.html
└── apps/
...
| Technical Articles | `/articles/` | 34-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme) |
