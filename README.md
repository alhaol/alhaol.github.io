...
│   ├── index.html      # Articles landing page (13 articles grid)
│   ├── Post_Images/    # Hero images for articles (Image_01.png through Image_13.png)
...
| Technical Articles | `/articles/` | 13-article series on agentic AI, cognitive systems, and advanced engineering practices (dark-blue theme) |
