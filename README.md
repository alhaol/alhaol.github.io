...
│   ├── index.html      # Articles landing page (61 articles grid)
...
│       └── # 61 article pages, the-paradigm-shift.html … four-doors-one-room.html (plus verbs-not-nouns.ar.html, the first Arabic RTL edition)
...
| Technical Articles | `/articles/` | 61-article series on agentic AI, cognitive systems, AI security, and advanced engineering practices (dark-blue theme). Data-carrying diagrams are authored inline SVG (see `the-experience-bottleneck.html`); heroes are authored as vector art and exported to `Post_Images/Image_NN.png` |
